<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
        ...
        <h1 class="mt-8 text-2xl font-medium text-gray-900">
            ข้อความแจ้งเตือน: ไม่ได้รับอนุญาตให้เข้าถึงหน้านี้!
        </h1>
        <br><hr><br>
        <p>
            คุณไม่มีสิทธิ์เข้าถึงหน้านี้ในขณะนี้
            การเข้าถึงหน้าเว็บที่จำกัดสิทธิ์โดยไม่ได้รับอนุญาตอาจส่งผลต่อความปลอดภัยของระบบ
        </p>
        <p>
            **คำแนะนำ:**
        </p>
        <ul>
            <li>หากคุณเชื่อว่าคุณควรได้รับอนุญาตให้เข้าถึงหน้านี้ กรุณาติดต่อผู้ดูแลระบบ</li>
            <li>เพื่อความปลอดภัยของข้อมูล โปรดหลีกเลี่ยงการเข้าถึงหน้าเว็บที่คุณไม่ได้รับอนุญาต</li>
        </ul>
    </div>
